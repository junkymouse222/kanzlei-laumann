...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${SITE.brand} — Insolvenzverwaltung & Verwertung` },
      { name: "description", content: `${SITE.verwalter}, ${SITE.role} in ${SITE_OFFICE_CITIES}. Freihändiger Verkauf aus der Insolvenzmasse — Premium-Büroausstattung, Design-Klassiker und Kaffeetechnik.` },
      { name: "author", content: SITE.legalName },
      { property: "og:title", content: `${SITE.brand} — Insolvenzverwaltung & Verwertung` },
      ...
      { name: "twitter:title", content: `${SITE.brand} — Insolvenzverwaltung & Verwertung` },
